...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //设置动画帧
        imageView.animationImages=[NSArray arrayWithObjects: [UIImage imageNamed:@"3.tiff"],
        ...
        Infolabel.textColor = [UIColor colorWithRed:246/255 green:165/255 blue:39/255 alpha:1];
